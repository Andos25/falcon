...
echo "export HADOOP_HOME=/usr/local/lib/hadoop-2.2.0" >> ${env}
echo "export PATH=$PATH:$JAVA_HOME/bin:$HADOOP_HOME/sbin:$HADOOP_HOME/bin" >> ${env}

#config hadoop
cp core-site.xml yarn-site.xml mapred-site.xml hdfs-site.xml hadoop_env.sh ${HADOOP_CONFIG}
